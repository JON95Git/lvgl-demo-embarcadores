...
typedef struct {
    ...
    lv_chart_series_t *pitch_line;
    lv_chart_series_t *roll_line;
...
typedef struct {
    _gui_label_st latitude_label;
    _gui_label_st longitude_label;
    _gui_label_st altitude_label;
    _gui_label_st tracked_satellites_label;
    lv_style_t gps_label_style;
    _gui_task_st gps_task;
} gui_gps_screen_st;
